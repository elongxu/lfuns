...
var Zepto = (function() {
  ...
  function f(e, n) {
    return "number" != typeof n || U[u(e)] ? n : n + "px";
  }
  function d(e) {
    var n, t;
    return (
  ...
  function I(e, n) {
    n(e);
    for (var t = 0, i = e.childNodes.length; i > t; t++) I(e.childNodes[t], n);
  }
  var T,
    b,
    S,
    ...
    N = /^\s*<(\w+|!)[^>]*>/,
    B = /^<(\w+)\s*\/?>(?:<\/\1>|)$/,
    W = /<(?!area|br|col|embed|hr|img|input|link|meta|param)(([\w:]+)[^>]*)\/>/gi,
    $ = /^(?:body|html)$/i,
    V = /([A-Z])/g,
    R = ["val", "css", "html", "text", "data", "width", "height", "offset"],
    D = ["after", "prepend", "before", "append"],
    F = C.createElement("table"),
  ...
  return (
    ...
    (k = function(e) {
      return O.call(e, function(n, t) {
        return e.indexOf(n) == t;
      });
    }),
    (X.fragment = function(e, n, t) {
      var i, o, a;
      return (
        B.test(e) && (i = S(C.createElement(RegExp.$1))),
        i ||
          (e.replace && (e = e.replace(W, "<$1></$2>")),
          n === T && (n = N.test(e) && RegExp.$1),
          n in Z || (n = "*"),
          (a = Z[n]),
          (a.innerHTML = "" + e),
          (i = S.each(E.call(a.childNodes), function() {
            a.removeChild(this);
          }))),
        r(t) &&
          ((o = S(i)),
    ...
    (X.init = function(e, t) {
      ...
      if ("string" == typeof e)
        if (((e = e.trim()), "<" == e[0] && N.test(e)))
          (i = X.fragment(e, RegExp.$1, t)), (e = null);
        else {
          if (t !== T) return S(t).find(e);
          i = X.qsa(C, e);
        }
      else {
        if (n(e)) return S(C).ready(e);
        if (X.isZ(e)) return e;
        if (K(e)) i = s(e);
        else if (o(e)) (i = [e]), (e = null);
        else if (N.test(e))
          (i = X.fragment(e.trim(), RegExp.$1, t)), (e = null);
        else {
          if (t !== T) return S(t).find(e);
          i = X.qsa(C, e);
        }
    ...
    (S.fn = {
      ...
      concat: function() {
        ...
        for (e = 0; e < arguments.length; e++)
          (n = arguments[e]), (t[e] = X.isZ(n) ? n.toArray() : n);
        return _.apply(X.isZ(this) ? this.toArray() : this, t);
      },
      map: function(e) {
        return S(
      ...
      get: function(e) {
        return e === T ? E.call(this) : this[e >= 0 ? e : e + this.length];
      },
      toArray: function() {
        return this.get();
      },
        ...
        return n(e)
          ...
          : S(
              O.call(this, function(n) {
                return X.matches(n, e);
              })
            );
      },
      add: function(e, n) {
        return S(k(this.concat(S(e, n))));
      },
      is: function(e) {
      ...
      closest: function(e, n) {
        ...
        for (
          ...
          t && !(o ? o.indexOf(t) >= 0 : X.matches(t, e));
      ...
      parent: function(e) {
        return g(k(this.pluck("parentNode")), e);
      },
      children: function(e) {
        return g(
          this.map(function() {
      ...
      siblings: function(e) {
        return g(
          this.map(function(e, n) {
            return O.call(p(n.parentNode), function(e) {
              return e !== n;
            });
          }),
          e
      ...
      data: function(e, n) {
        var t = "data-" + e.replace(V, "-$1").toLowerCase(),
      ...
      offset: function(e) {
        ...
        if (!S.contains(C.documentElement, this[0])) return { top: 0, left: 0 };
      ...
      css: function(n, t) {
        if (arguments.length < 2) {
          ...
          if (((i = getComputedStyle(o, "")), "string" == typeof n))
            return o.style[A(n)] || i.getPropertyValue(n);
          if (K(n)) {
            var r = {};
            return (
              S.each(n, function(e, n) {
                r[n] = o.style[A(n)] || i.getPropertyValue(n);
              }),
              r
            );
          }
          ...
          ? this.each(function(n) {
              if ("className" in this) {
                ...
                i.split(/\s+/g).forEach(function(e) {
                  S(this).hasClass(e) || M.push(e);
                }, this),
                  M.length && w(this, t + (t ? " " : "") + M.join(" "));
              }
            })
          : this;
      },
      ...
      position: function() {
        if (this.length) {
          var e = this[0],
            n = this.offsetParent(),
            t = this.offset(),
            i = $.test(n[0].nodeName) ? { top: 0, left: 0 } : n.offset();
          return (
      ...
      offsetParent: function() {
        return this.map(function() {
          for (
            var e = this.offsetParent || C.body;
      ...
      (S.fn[n] = function() {
        var n,
          ...
          r = S.map(arguments, function(t) {
            return (
              (n = e(t)),
              "object" == n || "array" == n || null == t ? t : X.fragment(t)
            );
          }),
          a = this.length > 1;
        return r.length < 1
                  ...
                  0 == t
                    ...
                    : 1 == t
                      ...
                      : 2 == t
                        ? n
                        : null);
              var s = S.contains(C.documentElement, o);
              r.forEach(function(e) {
    ...
    (X.Z.prototype = h.prototype = S.fn),
    (X.uniq = k),
...
(window.Zepto = Zepto),
      ...
      (e.ajax = function(n) {
        ...
        if (
          ...
          (x = c.mimeType || x) &&
            ...
            A.overrideMimeType && A.overrideMimeType(x)),
          (c.contentType ||
            (c.contentType !== !1 &&
              c.data &&
          ...
          for (g in c.headers) T(g, c.headers[g]);
        if (
          ((A.setRequestHeader = T),
          (A.onreadystatechange = function() {
            if (4 == A.readyState) {
              (A.onreadystatechange = u), clearTimeout(w);
              var n,
                t = !1;
              if (
                ...
                if (
                  ((h =
                    h || l(c.mimeType || A.getResponseHeader("content-type"))),
                  ...
                  if (t) return s(t, "parsererror", A, c, p);
                }
                a(n, A, c, p);
              } else
                s(A.statusText || null, A.status ? "error" : "abort", A, c, p);
            }
          }),
          r(A, c) === !1)
        )
          return A.abort(), s(null, "abort", A, c, p), A;
        if (c.xhrFields) for (g in c.xhrFields) A[g] = c.xhrFields[g];
        var P = "async" in c ? c.async : !0;
        A.open(c.type, c.url, P, c.username, c.password);
        for (g in I) k.apply(A, I[g]);
        return (
          c.timeout > 0 &&
            (w = setTimeout(function() {
              (A.onreadystatechange = u),
                A.abort(),
                s(null, "timeout", A, c, p);
            }, c.timeout)),
          A.send(c.data ? c.data : null),
          A
        );
      }),
      (e.get = function() {
  ...
  (function(e) {
    e.Callbacks = function(n) {
      ...
      var t,
        ...
        l = function(e) {
          for (
            t = n.memory && e, i = !0, s = r || 0, r = 0, a = c.length, o = !0;
            c && a > s;
            ++s
          )
          ...
          (o = !1),
            c &&
              (u ? u.length && l(u.shift()) : t ? (c.length = 0) : f.disable());
        },
        f = {
          add: function() {
            if (c) {
            ...
            return (
              c &&
                e.each(arguments, function(n, t) {
                  for (var i; (i = e.inArray(t, c, i)) > -1; )
                    c.splice(i, 1), o && (a >= i && --a, s >= i && --s);
                }),
              this
            );
          },
  ...
  (function(e) {
    ...
    (e.when = function(i) {
      var o,
        ...
        c = s.length,
        u = 0,
        l = 1 !== c || (i && e.isFunction(i.promise)) ? c : 0,
        f = 1 === l ? i : n(),
        d = function(e, n, i) {
          return function(r) {
            (n[e] = this),
              (i[e] = arguments.length > 1 ? t.call(arguments) : r),
              i === o ? f.notifyWith(n, i) : --l || f.resolveWith(n, i);
          };
        };
      if (c > 1)
        for (o = new Array(c), r = new Array(c), a = new Array(c); c > u; ++u)
          s[u] && e.isFunction(s[u].promise)
            ? s[u]
                .promise()
                .done(d(u, a, s))
                .fail(f.reject)
  ...
  (function(e) {
    ...
    function r(e, n) {
      return (e.del && !y && e.e in w) || !!n;
    }
    function a(e) {
      return x[e] || (y && w[e]) || e;
    }
    function s(t, o, s, c, l, d, p) {
      var h = n(t),
        m = g[h] || (g[h] = []);
      ...
      return (
        (t || !n.isDefaultPrevented) &&
          ...
          e.each(S, function(e, i) {
            var o = t[e];
            (n[e] = function() {
              return (this[i] = I), o && o.apply(t, arguments);
            }),
              (n[i] = T);
          }),
    ...
    (e.fn.delegate = function(e, n, t) {
        ...
        return n && !m(n)
          ...
          : (m(t) || h(o) || o === !1 || ((o = i), (i = t), (t = f)),
            ...
            d.each(function(f, d) {
              r &&
                (a = function(e) {
                  return c(d, e.type, o), o.apply(this, arguments);
                }),
                t &&
                  (u = function(n) {
                    var i,
      ...
      (e.fn.trigger = function(n, t) {
        return (
          (n = m(n) || e.isPlainObject(n) ? e.Event(n) : u(n)),
          (n._args = t),
          this.each(function() {
            n.type in w && "function" == typeof this[n.type]
              ? this[n.type]()
  ...
  (function(e, n) {
    ...
    e.each(m, function(e, t) {
      ...
      ] = y[(u = h + "transition-delay")] = y[
        (c = h + "transition-timing-function")
      ] = y[(l = h + "animation-name")] = y[(f = h + "animation-duration")] = y[
        (p = h + "animation-delay")
        ...
        return (
          (I = function(n) {
            if ("undefined" != typeof n) {
              ...
              e(n.target).unbind(M, I);
            } else e(this).unbind(M, I);
  ...
  !(function(e, n) {
    ...
    function s(e, n, t) {
      "openEnterpriseChat" == e && (n.errCode = n.err_code),
        ...
        delete n.err_detail;
      var i = n.errMsg;
      i || ((i = n.err_msg), delete n.err_msg, (i = c(e, i)), (n.errMsg = i)),
        (t = t || {})._complete && (t._complete(n), delete t._complete),
        (i = n.errMsg || ""),
        O.debug && !t.isInnerInvoke && alert(JSON.stringify(n));
      var o = i.indexOf(":");
    ...
    function f() {
      if (!(T || b || O.debug || "6.0.2" > k || _.systemType < 0)) {
        var e = new Image();
        (_.appId = O.appId),
          (_.initTime = P.initEndTime - P.initStartTime),
          (_.preVerifyTime = P.preVerifyEndTime - P.preVerifyStartTime),
          U.getNetworkType({
            isInnerInvoke: !0,
            success: function(n) {
    ...
    if (!e.jWeixin) {
      var g = {
        ...
        T = !!I.match("mac") || !!I.match("win"),
        b = -1 != x.indexOf("wxdebugger"),
        S = -1 != x.indexOf("micromessenger"),
        M = -1 != x.indexOf("android"),
        A = -1 != x.indexOf("iphone") || -1 != x.indexOf("ipad"),
        k = (function() {
          var e =
            x.match(/micromessenger\/(\d+\.\d+\.\d+)/) ||
            x.match(/micromessenger\/(\d+\.\d+)/);
          return e ? e[1] : "";
        })(),
        P = {
          initStartTime: d(),
      ...
      var L = !1,
        ...
        U = {
          config: function(e) {
            ...
            p(function() {
              if (n)
                t(
                  g.config,
                  { verifyJsApiList: u(O.jsApiList) },
                  (function() {
                    (E._complete = function(e) {
                      (P.preVerifyEndTime = d()), (C.state = 1), (C.data = e);
                    }),
                      (E.success = function() {
                        _.isPreVerifyOk = 0;
                      }),
                ...
                C.state = 1;
                for (var e = E._completes, i = 0, o = e.length; o > i; ++i)
                  e[i]();
                E._completes = [];
              }
            }),
          ...
          ready: function(e) {
            0 != C.state ? e() : (E._completes.push(e), !S && O.debug && e());
          },
          error: function(e) {
            "6.0.2" > k || (-1 == C.state ? e(C.data) : (E._fail = e));
          },
  ...
  require(["HeaderController", "AjaxController"], function(e) {
    function n() {
      e.init(function() {
        e.hasLogin && i && e.userInfo.shopId != i && (e.hasLogin = !1),
          (t.loading = 0),
          (t.selfId = e.userInfo.shopId),
          (t.shopId = e.userInfo.shopId),
          (t.shopName = e.userInfo.shopSerial || e.userInfo.shopName),
          t.init(),
          (t.fromUrl =
    ...
    var t = avalon.define({
      ...
      qushiHandler: function() {
        location.href =
          location.href.indexOf("caibao918.com") >= 0
            ? "https://yly.caibao918.com/zst/page/index.html?sid=" +
              e.userInfo.shopId
            : "https://yly.caibao918.com/zst/page/index.html?sid=" +
              e.userInfo.shopId;
      },
    ...
    i && (t.client = "app");
    var o = UtilTool.getQueryStringByName("shopId") || "";
    o && (i = o), n();
  }),
  define("controllers/FindController", function() {});
